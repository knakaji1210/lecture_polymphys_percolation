# Functions necessary to calculate forest fire (random firing)
...
# function for initial firing points
    intial_firing_point = rd.randint(0, end_point_id - 1)
    point_attribute = currentConfig[intial_firing_point]
