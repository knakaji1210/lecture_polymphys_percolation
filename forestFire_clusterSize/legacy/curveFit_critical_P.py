...
#    logparam_u, logcov_u = curve_fit(loglogFit, logcropped_setU[0], logcropped_setU[1])
    ...
    ax1 = fig.add_subplot(121, title='Percolation Cluster Size vs Probability of Occupying Sites', 
            xlabel='Probability of Occupying Sites', ylabel='Percolation Cluster Size')
    ...
    ax2 = fig.add_subplot(122, title='Scaling of Percolation Cluster Size', 
            xlabel='Log(p - pc)', ylabel='Log(Percolation Cluster Size)')
    ...
    fig.text(0.15, 0.72, resultTextU)
    #fig.text(0.57, 0.25, resultTextlogL)
    fig.text(0.58, 0.72, resultTextlogU)

    fig.savefig("./png/percolated_cluster_size_mean_fit.png", dpi=300)
