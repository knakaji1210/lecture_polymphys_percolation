...
'''
How to use
% python3 curveFit_critical_v2.py args[1] args[2] args[3]
...
if __name__ == '__main__':
    ...
    paramL, covL = curve_fit(power_fitL, cropped_x_arrayL, cropped_y_arrayL)
    paramU, covU = curve_fit(power_fitU, cropped_x_arrayU, cropped_y_arrayU)
