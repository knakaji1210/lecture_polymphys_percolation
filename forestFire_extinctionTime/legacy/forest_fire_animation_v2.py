...
configration_black = amp.blocks.Scatter(x_black, y_black, ax=ax1, s=2, color='black')
configration_green = amp.blocks.Scatter(x_green, y_green, ax=ax1, s=2, color='green')
configration_red = amp.blocks.Scatter(x_red, y_red, ax=ax1, s=2, color='red')
