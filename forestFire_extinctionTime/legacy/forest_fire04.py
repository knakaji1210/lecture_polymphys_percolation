...
currentConfig = pf.initialFire(lattice_y, initialConfig)
fireCount = pf.fireCount(end_point_id, currentConfig)
...
while fireCount > 0:
        ...
        fireCount = pf.fireCount(end_point_id, currentConfig)
        print(fireCount)
        updatedConfig = pf.fireSpread(lattice_x, lattice_y, end_point_id, currentConfig)
