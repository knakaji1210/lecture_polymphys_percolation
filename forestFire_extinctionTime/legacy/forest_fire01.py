...
pointsCoordinates = pf.pointsCoordinates(end_point_id, initialConfig)
...
#updateConfig = pf.initialFire(lattice_x, lattice_y, currentConfig)
#print(updateConfig)
#x_black.append(pointsCoordinates[0])
#y_black.append(pointsCoordinates[1])
#x_green.append(pointsCoordinates[2])
...
ax1 = fig.add_subplot(111, title='Percolation', xlabel='X', ylabel='Y',
